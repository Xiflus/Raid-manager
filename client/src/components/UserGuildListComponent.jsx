        ...
        if (userCharacters) {
            ...
            const fetchGuildDetails = async () => {
                ...
                try {
                    ...
                    const characterGuildDetails =
                        await Promise.all(guildPromises);

                    // Log para verificar la estructura
                    console.log(
                        "Character Guild Details:",
                        characterGuildDetails
                    );
                    ...
                    toast.error(
                        "Error al buscar los datos de la hermandad",
                        err
                    );
                } finally {
                    setLoading(false);
